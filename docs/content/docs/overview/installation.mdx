---
title: "Installation"
description: "Download and install VoiceIt on macOS, Windows, or Linux"
---

## Download

VoiceIt is available for macOS and Windows, with Linux builds coming soon.
...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [voiceit_aarch64.app.tar.gz](https://github.com/jamiepine/voicebox/releases/latest/download/voiceit_aarch64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf voiceit_aarch64.app.tar.gz

    # Move to Applications
    mv VoiceIt.app /Applications/
    ```
  </Tab>
  <Tab value="Intel">
    Download: [voiceit_x64.app.tar.gz](https://github.com/jamiepine/voicebox/releases/latest/download/voiceit_x64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf voiceit_x64.app.tar.gz
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [voiceit_x64_en-US.msi](https://github.com/jamiepine/voicebox/releases/latest/download/voiceit_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [voiceit_x64-setup.exe](https://github.com/jamiepine/voicebox/releases/latest/download/voiceit_x64-setup.exe)
...
When you launch VoiceIt for the first time:
...
2. **Data Directory** — Voice profiles and generated audio are stored in:
   - macOS: `~/Library/Application Support/com.tapnetix.voiceit/`
   - Windows: `%APPDATA%/com.tapnetix.voiceit/`
   - Linux: `~/.config/com.tapnetix.voiceit/`
