...
VoiceIt keeps a complete history of all generated audio, making it easy to find, reuse, and manage your creations.
...
- **macOS**: `~/Library/Application Support/com.tapnetix.voiceit/data/`
- **Windows**: `%APPDATA%/com.tapnetix.voiceit/data/`
- **Linux**: `~/.config/com.tapnetix.voiceit/data/`
