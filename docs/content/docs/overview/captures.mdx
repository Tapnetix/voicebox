...
how VoiceIt strips Whisper loop hallucinations *before* the LLM sees the
...
The original audio is kept alongside the transcript in your VoiceIt data
...
[Remote Mode](/overview/remote-mode) for running VoiceIt as a server the rest
