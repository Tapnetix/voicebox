...
description: "A map of the three places you can record and transcribe audio in VoiceIt — dictation, captures, and voice-profile samples."
---

## Overview

VoiceIt records and transcribes audio in three different contexts, each
...
| Record a thought, a meeting, or a voice memo inside VoiceIt | Captures tab | [Captures](/overview/captures) |
...
<Callout type="info">
  ...
  hard inputs — most famously the "thanks for watching" loop. VoiceIt
