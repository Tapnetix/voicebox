...
VoiceIt is the **open-source, local-first AI voice studio**. It closes the
...
- **Agents talk back** — any MCP-aware agent can call VoiceIt to speak in
...
VoiceIt also runs a full speech recognition and local LLM stack, shared
