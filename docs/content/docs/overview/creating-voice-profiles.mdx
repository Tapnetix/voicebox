...
A **voice profile** is a saved voice you can reuse across generations, stories, and the API. As of 0.4, VoiceIt profiles come in two flavors that map to two different ways of getting a voice:
