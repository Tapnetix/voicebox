---
title: "Quick Start"
description: "Get started with VoiceIt in 5 minutes"
---
...
Make sure you have [installed VoiceIt](/overview/installation) and launched the app.

## Step 1: Create a Voice Profile

Voice profiles are the foundation of VoiceIt. Each profile contains voice samples that the AI uses to clone the voice.
...
<Steps>
  ...
  <Step title="Enter Text">
    ...
    ```
    Hello! This is my first voice generation with VoiceIt.
    ```
...
<Cards>
  ...
  <Card title="API Integration" href="/api-reference">
    Integrate VoiceIt into your own applications
  </Card>
