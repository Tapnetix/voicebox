---
title: "VoiceIt Documentation"
description: "VoiceIt is the open-source, local-first AI voice studio — a free alternative to ElevenLabs and WisprFlow, running entirely on your machine."
---

VoiceIt is the **open-source, local-first AI voice studio** — a free
...
![VoiceIt App Screenshot](/images/app-screenshot-1.webp)
...
- **Agents speak back** — any MCP-aware agent can call VoiceIt to speak in one of your cloned voices
...
| Platform | Download |
|----------|----------|
| macOS (Apple Silicon) | [Download DMG](https://voiceit.sh/download/mac-arm) |
| macOS (Intel) | [Download DMG](https://voiceit.sh/download/mac-intel) |
| Windows | [Download MSI](https://voiceit.sh/download/windows) |
...
- [Installation](/overview/installation) — download and install VoiceIt
