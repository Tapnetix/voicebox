---
title: "Architecture"
description: "Understanding VoiceIt's technical architecture"
---

## System Overview

VoiceIt uses a client-server architecture with a React frontend and Python backend. The desktop app is built with Tauri and contains two main layers:
