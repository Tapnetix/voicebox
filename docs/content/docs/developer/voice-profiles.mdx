...
description: "How voice profile management works in VoiceIt"
---

## Overview

Voice profiles are the unit of "a saved voice" in VoiceIt. As of 0.4 they support two flavors backed by the same `profiles` table:
