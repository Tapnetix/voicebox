...
description: "Set up your local development environment for VoiceIt"
---
...
| `just build-server-cuda` | **Windows:** CUDA server binary only, placed in `%APPDATA%/com.tapnetix.voiceit/backends/cuda` for local testing |
...
<Files>
  <Folder name="voiceit" defaultOpen>
    <Folder name="app">
      <Folder name="src">
